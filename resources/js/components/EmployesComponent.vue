                ...
                <div class="card-body">
                    <div style="overflow-x:auto;  min-width:80%">
                        ...
                        >
                            ...
                            <tbody>
                                <tr
                                    v-for="employe in arrayEmployes"
                                    :key="employe.id"
                                >
                                    <td>
                                        <button
                                ...
                                >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small
                                            id="textHelp"
                                            class="form-text text-muted"
                                            >Ingrese nombre o nombres</small
                                        >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small
                                            id="textHelp"
                                            class="form-text text-muted"
                                            >Ingrese primer apellido</small
                                        >
                                    </div>
                                    <div class="form-group">
                                        <label for="inputSecondLastName"
                                            >Segundo paellido</label
                                        >
                                        <input
                                            type="text"
                                            class="form-control"
                                        ...
                                        <small
                                            id="textHelp"
                                            class="form-text text-muted"
                                            >Ingrese segundo apellido</small
                                        >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small
                                            id="textHelp"
                                            class="form-text text-muted"
                                            >Ingrese su tipo de contrato</small
                                        >
                                    </div>
                                </div>
                            </form>
                ...
                >
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            >
                                <div
                                    style="overflow-x:auto; min-width:80%"
                                >
                                    <table
                                        class="table table-bordered table-striped table-sm"
                                    >
...
export default {
    ...
    methods: {
        ...
        enableEmploye(id) {
            swal({          //mostrar alesta de confirmacion son sweet alers
